...
import Femaleprof from "../../Assets/proff.png";
      ...
      <div className="testimonial-container">
        <div className="testimonial-cards">
          ...
          <div className="testimonial-content">
            <ImQuotesLeft />
            &nbsp; I think the website is very user friendly and easy to
            navigate. I also like that there is a lot of information about the
            products.
            <ImQuotesRight />
          </div>
